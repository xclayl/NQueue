...
internal class PostgresDbUpgrader07
{
    ...
    public async ValueTask Upgrade(DbTransaction tran, bool isCitus)
    {
        ...
        var sql = @"
            ALTER TABLE NQueue.Queue ALTER Name TYPE text;
            ALTER TABLE NQueue.WorkItem ALTER QueueName TYPE text;
            ALTER TABLE NQueue.WorkItemCompleted ALTER QueueName TYPE text;
        ";
